...
var require_ort_min = __commonJS({
  "node_modules/onnxruntime-web/dist/ort.min.js"(exports, module) {
    var ort = (() => {
      ...
      var _n = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
      ...
      var et = (e, t) => {
        for (var n in t)
          bn(e, n, { get: t[n], enumerable: true });
      }, Gu = (e, t, n, r) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let o of Nu(t))
            !Lu.call(e, o) && o !== n && bn(e, o, { get: () => t[o], enumerable: !(r = Vu(t, o)) || r.enumerable });
        return e;
      };
      var at = (e) => Gu(bn({}, "__esModule", { value: true }), e);
      var $t, Fe, Ne, Wu, hr, wn = E(() => {
        "use strict";
        $t = /* @__PURE__ */ new Map(), Fe = [], Ne = (e, t, n) => {
          if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            let r = $t.get(e);
            if (r === void 0)
              $t.set(e, { backend: t, priority: n });
            else {
              if (r.priority > n)
                return;
          ...
          let t = e.executionProviders || [], n = t.map((u) => typeof u == "string" ? u : u.name), r = n.length === 0 ? Fe : n, o, i = [], s = /* @__PURE__ */ new Set();
          for (let u of r) {
            let d = await Wu(u);
      ...
      var _r, ge, $n = E(() => {
        "use strict";
        br();
        _r = "warning", ge = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: yr }, set logLevel(e) {
          if (e !== void 0) {
        ...
        Object.defineProperty(ge, "logLevel", { enumerable: true });
      });
      var te, wr = E(() => {
        "use strict";
        $n();
      ...
      var vn, Sr, Tr, Ir, Cr, Ar, kr = E(() => {
        ...
        vn = (e, t) => {
          ...
          return u === "RGBA" ? new pe("float32", l, [1, 4, n, r]) : new pe("float32", l, [1, 3, n, r]);
        }, Sr = async (e, t) => {
          ...
          if (n) {
            ...
            if (c != null) {
              let p = e.height, f = e.width;
              return c.drawImage(e, 0, 0, f, p), s = c.getImageData(0, 0, f, p).data, a.height = p, a.width = f, vn(s, a);
            } else
              throw new Error("Can not access image data");
          } else {
            if (i)
          ...
          return new pe({ location: "texture", type: "float32", texture: e, dims: s, download: o, dispose: i });
        }, Ir = (e, t) => {
          let { dataType: n, dims: r, download: o, dispose: i } = t;
          return new pe({ location: "gpu-buffer", type: n ?? "float32", gpuBuffer: e, dims: r, download: o, dispose: i });
        }, Cr = (e, t) => {
          let { dataType: n, dims: r, download: o, dispose: i } = t;
          return new pe({ location: "ml-tensor", type: n ?? "float32", mlTensor: e, dims: r, download: o, dispose: i });
        }, Ar = (e, t, n) => new pe({ location: "cpu-pinned", type: e, data: t, dims: n ?? [t.length] });
      });
      var Ke, ut, Er, Pr, zr = E(() => {
        "use strict";
        Ke = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), ut = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), Er = false, Pr = () => {
          if (!Er) {
            Er = true;
            ...
            e && (Ke.set("int64", BigInt64Array), ut.set(BigInt64Array, "int64")), t && (Ke.set("uint64", BigUint64Array), ut.set(BigUint64Array, "uint64")), r ? (Ke.set("float16", n), ut.set(n, "float16")) : Ke.set("float16", Uint16Array);
          }
        };
      });
      var Or, Dr, Br = E(() => {
      ...
      var dt, Mr, fe, me, Sn = E(() => {
        "use strict";
        $n();
        dt = (e, t) => {
          (typeof ge.trace > "u" ? !ge.wasm.trace : !ge.trace) || console.timeStamp(`${e}::ORT::${t}`);
        }, Mr = (e, t) => {
          var _a2;
      ...
      var xt, Rr = E(() => {
        ...
        xt = class e {
            ...
            if (typeof n == "object") {
              ...
              if (Array.isArray(n)) {
                ...
                for (let c of this.outputNames)
                  if (l.indexOf(c) !== -1) {
                    let p = n[c];
                    (p === null || p instanceof $e) && (d = true, s = false, o[c] = p);
                  }
                if (d) {
                  if (typeof r == "object" && r !== null)
                    i = r;
          ...
          static async create(t, n, r, o) {
            ...
            let [a, u] = await hr(s), d = await a.createInferenceSessionHandler(i, u);
            return me(), new e(d);
          }
          startProfiling() {
      ...
      var Tn = {};
      et(Tn, { InferenceSession: () => Ur, TRACE: () => dt, TRACE_FUNC_BEGIN: () => fe, TRACE_FUNC_END: () => me, Tensor: () => $e, env: () => te, registerBackend: () => Ne });
      var ve = E(() => {
        "use strict";
        gr();
        wr();
      ...
      var qr, Fr, Hu, jr = E(() => {
        ...
        Le();
        Tt();
        qr = "ort-wasm-proxy-worker", Fr = ((_a2 = globalThis.self) == null ? void 0 : _a2.name) === qr;
        Fr && (self.onmessage = (e) => {
          ...
          try {
            switch (t) {
              ...
              case "run": {
                ...
                Pt(r, o, i, s, new Array(s.length).fill(null), a).then((u) => {
      ...
      var qu, Fu, ye, Dt, Cn, Ku, ju, Xr, Zu, Zr, Yr, Qr, Jr, Tt = E(() => {
        "use strict";
        St();
        qu = typeof location > "u" ? void 0 : location.origin, Fu = () => {
          ...
          let e = await Xr(ye);
          return [e, Zr(e)];
        }, Qr = void 0, Jr = async (e, t, n) => {
          if (!e && !t && Qr && ye && Cn(ye))
            return [void 0, Qr];
          {
            let r = "ort-wasm-simd-threaded.jsep.mjs", o = e ?? Ku(r, t), i = n && o && !Cn(o, t), s = i ? await Xr(o) : o ?? ju(r, t);
            return [i ? s : void 0, await Zu(s)];
          }
        };
      });
      var An, kn, Bt, eo, Qu, Xu, Yu, It, ne, Le = E(() => {
        "use strict";
        Tt();
        kn = false, Bt = false, eo = false, Qu = () => {
          ...
          let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, s = o == null ? void 0 : o.mjs, a = (s == null ? void 0 : s.href) ?? s, u = o == null ? void 0 : o.wasm, d = (u == null ? void 0 : u.href) ?? u, l = e.wasmBinary, [c, p] = await Jr(a, i, n > 1), f = false, m = [];
          if (t > 0 && m.push(new Promise((h) => {
            ...
            p(y).then((g) => {
              Bt = false, kn = true, An = g, h(), c && URL.revokeObjectURL(c);
            }, (g) => {
              Bt = false, eo = true, b(g);
            });
      ...
      var to, no = E(() => {
        ...
        to = (e) => {
          ...
          try {
            ...
            let i = 0;
            return (e == null ? void 0 : e.tag) !== void 0 && (i = be(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && Y("Can't create run options."), (e == null ? void 0 : e.extra) !== void 0 && ct(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
              let u = be(s, r), d = be(a, r);
      ...
      var Ju, ed, td, Rt, nd, ro, oo = E(() => {
        ...
        Ju = (e) => {
          ...
          for (let r of t) {
            ...
            let s = be(o, n), a = i.length, u = 0, d = 0;
            if (a > 0) {
          ...
          td(o);
          try {
            let i = Ju(o.graphOptimizationLevel ?? "all"), s = ed(o.executionMode ?? "sequential"), a = typeof o.logId == "string" ? be(o.logId, r) : 0, u = o.logSeverityLevel ?? 2;
            ...
            let l = typeof o.optimizedModelFilePath == "string" ? be(o.optimizedModelFilePath, r) : 0;
            ...
            return o.extra !== void 0 && ct(o.extra, "", /* @__PURE__ */ new WeakSet(), (c, p) => {
              Rt(n, c, p, r);
            }), [n, r];
          } catch (i) {
      ...
      var Ge, ke, We, tt, pt, Ut, Vt, En, V = E(() => {
        "use strict";
        Ge = (e) => {
          switch (e) {
            case "int8":
        ...
        }, Ut = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Vt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", En = (e) => {
          switch (e) {
            case "none":
              return 0;
            case "cpu":
            ...
            if (false)
              try {
                ...
                if (t.code === "ERR_FS_FILE_TOO_LARGE") {
                  let { createReadStream: n } = _n("node:fs"), r = n(e), o = [];
      ...
      var zn, Pe, x, Ze, Lt, ao, uo, q = E(() => {
        ...
        }, ao = -34028234663852886e22, uo = 34028234663852886e22;
      });
      var Gt, On = E(() => {
        "use strict";
        V();
      ...
      var co, Bn, po, sd, lo, ad, mo, Wt, Ht, Dn, fo, ho = E(() => {
        "use strict";
        V();
        Ee();
        co = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Bn = (e, t) => {
          if (t === "int32")
            return e;
          let n = co.get(t);
          if (!n)
          ...
          let o = e.byteLength / r, i = new (tt(t))(e.buffer, e.byteOffset, o);
          switch (t) {
            case "int64":
            case "uint64": {
        ...
        }, sd = 1, lo = () => sd++, ad = /* @__PURE__ */ new Map([["int8", "int32"], ["uint8", "int32"], ["uint32", "int32"], ["int64", "int32"]]), mo = (e, t) => {
          let n = co.get(e);
          if (!n)
          ...
          async read(t) {
            if (this.fallbackDataType) {
              let n = await this.mlContext.readTensor(this.mlTensor), r = po(new Uint8Array(n), this.dataType);
              if (t) {
            ...
            if (this.wrapper) {
              if (this.wrapper.fallbackType)
                if (this.wrapper.fallbackType === "int32")
                  n = Bn(t, this.wrapper.type), this.wrapper.setIsDataConverted(true);
                else
          ...
          async download(t) {
            ...
            if (this.activeUpload) {
              let n = ((_a2 = this.wrapper) == null ? void 0 : _a2.isDataConverted) ? po(this.activeUpload, (_b = this.wrapper) == null ? void 0 : _b.type) : this.activeUpload;
              if (t) {
          ...
          registerTensor(t, n, r, o) {
            let i = this.getMLContext(t), s = lo(), a = new Wt({ sessionId: t, context: i, tensor: n, dataType: r, shape: o });
          ...
          async getCachedTensor(t, n, r, o, i, s, a) {
            ...
            return new Wt({ sessionId: t, context: u, tensor: d, dataType: n, shape: r, fallbackDataType: a });
          }
          releaseTensor(t) {
      ...
      var qt, ud, Ft, go = E(() => {
        ...
        ho();
        Ee();
        qt = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), ud = (e, t) => {
          if (e === t)
            return true;
          ...
          isGraphInputOutputTypeSupported(t, n, r = true) {
            let o = this.mlContextBySessionId.get(t), i = qt.get(Ge(n));
      ...
      var yo, Mn, Rn, dd, ld, bo, Vn, Un, wo, $o = E(() => {
        "use strict";
        Ee();
        Kt();
        yo = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), Mn = [], Rn = (e) => Math.ceil(Number(e) / 16) * 16, dd = (e) => {
        ...
        }, ld = 1, bo = () => ld++, Vn = async (e, t, n, r) => {
          let o = Rn(n), i = e.device.createBuffer({ size: o, usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ });
          try {
          ...
          upload(t, n) {
            let r = n.buffer, o = n.byteOffset, i = n.byteLength, s = Rn(i), a = this.storageCache.get(t);
            if (!a)
          ...
          memcpy(t, n) {
            ...
            let i = Rn(r.originalSize), s = this.backend.getCommandEncoder();
      ...
      var Qe, Gn, re, le, P, X, Wn, Xe, Te, B, jt, S, C, vo, Zt, Ln, xo, K = E(() => {
        "use strict";
        V();
        q();
        Qe = 64, Gn = (e, t) => {
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    ${g}
    return indices;
  }`, w = (k) => (m.offsetToIndices = true, s < 2 ? k : `o2i_${e}(${k})`), v = [];
          if (s >= 2)
            for (let k = s - 1; k >= 0; k--)
  ...
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
  }`, T = (k) => (m.indicesToOffset = true, s < 2 ? k : `i2o_${e}(${k})`), I = (...k) => s === 0 ? "0u" : `${p.indices}(${k.map(f).join(",")})`, A = (k, L) => s < 2 ? `${k}` : `${B(k, L, s)}`, z = (k, L, oe) => s < 2 ? `${k}=${oe};` : `${B(k, L, s)}=${oe};`, M = {}, R = (k, L) => {
  ...
  fn get_${e}ByIndices(indices: ${p.indices}) -> ${l} {
    return ${O(`i2o_${e}(indices)`)};
            ...
            let k = a.map((oe) => `d${oe}: u32`).join(", "), L = a.map((oe) => `d${oe}`).join(", ");
            return `
  fn get_${e}(${k}) -> ${l} {
    return get_${e}ByIndices(${I(L)});
            ...
            let L = k.map(f).join(",");
            return s === 0 ? O("0u") : s === 1 ? O(L[0]) : (m.get = true, m.getByIndices = true, m.indicesToOffset = true, `get_${e}(${L})`);
          }, Z = (k) => s < 2 ? O(k) : (m.getByIndices = true, m.indicesToOffset = true, `get_${e}ByIndices(${k})`), U = s < 2 ? "" : `
  ...
  fn set_${e}(${k}, value: ${l}) {
    set_${e}ByIndices(${I(L)}, value);
          ...
          return { impl: () => {
            let k = [], L = false;
            return m.offsetToIndices && (k.push(_), L = true), m.indicesToOffset && (k.push($), L = true), m.broadcastedIndicesToOffset && (Object.values(M).forEach((oe) => k.push(oe)), L = true), m.set && (k.push(Q), L = true), m.setByIndices && (k.push(U), L = true), m.get && (k.push(G), L = true), m.getByIndices && (k.push(ee), L = true), !i && L && k.unshift(`const ${b} = ${p.indices}(${n.join(",")});`, `const ${y} = ${p.indices}(${x.computeStrides(n).join(",")});`), k.join(`
`);
          }, type: p, offsetToIndices: w, indicesToOffset: T, broadcastedIndicesToOffset: R, indices: I, indicesGet: A, indicesSet: z, set: (...k) => {
            if (k.length !== s + 1)
              throw new Error(`indices length must be ${s}`);
            let L = k[s];
            if (typeof L != "string")
            ...
            return s === 0 ? W("0u", L) : s === 1 ? W(oe[0], L) : (m.set = true, m.setByIndices = true, m.indicesToOffset = true, `set_${e}(${oe}, ${L})`);
          }, setByOffset: W, setByIndices: (k, L) => s < 2 ? W(k, L) : (m.setByIndices = true, m.indicesToOffset = true, `set_${e}ByIndices(${k}, ${L});`), get: D, getByOffset: O, getByIndices: Z, usage: r, name: e, strides: y, shape: b, rank: s };
        }, S = (e, t, n, r = 1) => jt(e, t, n, "input", r), C = (e, t, n, r = 1) => jt(e, t, n, "output", r), vo = (e, t, n) => jt(e, t, n, "atomicOutput", 1), Zt = (e, t, n, r = 1) => jt(e, t, n, "internal", r), Ln = class {
          constructor(t, n) {
...
`);
      ...
      var cd, So, pd, md, fd, hd, ce, To, Io, Re = E(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        }, So = (e, t) => t.length !== 0 ? t : [...new Array(e).keys()].reverse(), pd = (e, t) => x.sortBasedOnPerm(e, So(e.length, t)), md = (e, t, n, r) => {
    ...
    var a: ${n.type.indices};`;
          ...
          let n = e.dataType, r = e.dims.length, o = So(r, t), i = pd(e.dims, o), s = e.dims, a = i, u = r < 2 || hd(o, e.dims), d;
          if (u)
            return d = (h) => {
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
      ...
      var gd, yd, bd, _d, wd, $d, vd, xd, Sd, Td, ze, Co, Ao, ko, Eo, Po, zo, Oo, Do, Bo, Mo, Ro = E(() => {
        "use strict";
        V();
        q();
        K();
       ...
       `, m = (h) => `
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ...
          let o = e.inputs.length === 1 ? n : Hn(e.inputs, n), i = o.axes;
          ...
          d.length > 0 && (u = e.compute(ce(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0], a = wd(a.length, u.dims.length));
      ...
      var Oe, Id, Xt, Hn, De, Cd, Ad, kd, Ed, Pd, zd, Od, Dd, Bd, Md, Be, Uo, Vo, No, Lo, Go, Wo, Ho, qo, Fo, Ko, Qt = E(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        }, Id = (e) => ["", "", `var value = ${e.getByIndices("input_indices")};`, ""], Xt = (e, t, n, r, o, i, s = false, a = false) => {
...
`)}
          ...
          let o = e.inputs, i = o.length === 1 ? n : Hn(o, n);
          e.compute(Xt(t, { hint: i.cacheKey, inputDependencies: ["rank"] }, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? Id : r, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
        }, Cd = (e, t) => {
          Oe(e.inputs), De(e, "ReduceLogSum", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${r.getByIndices("input_indices")};`, "value = log(value);"]);
        }, Ad = (e, t) => {
          Oe(e.inputs), De(e, "ReduceL1", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += abs(${r.getByIndices("input_indices")});`, ""]);
        }, kd = (e, t) => {
          Oe(e.inputs), De(e, "ReduceL2", t, (r, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${r.getByIndices("input_indices")}; value += (t * t);`, "value = sqrt(value);"]);
        }, Ed = (e, t) => {
          Oe(e.inputs), De(e, "ReduceLogSumExp", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += exp(${r.getByIndices("input_indices")});`, "value = log(value);"]);
        }, Pd = (e, t) => {
          Oe(e.inputs), De(e, "ReduceMax", t, (r, o, i) => {
            let s = [];
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = max(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Oe(e.inputs), De(e, "ReduceMean", t, (r, o, i) => {
            let s = 1;
            for (let a = 0; a < r.rank; a++)
          ...
          Oe(e.inputs), De(e, "ReduceMin", t, (r, o, i) => {
            let s = [];
            for (let a = 0; a < r.rank; a++)
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = min(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Oe(e.inputs), De(e, "ReduceProd", t, (r, o) => [`var value = ${o.type.storage}(1);`, "", `value *= ${r.getByIndices("input_indices")};`, ""]);
        }, Bd = (e, t) => {
          Oe(e.inputs), De(e, "ReduceSum", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${r.getByIndices("input_indices")};`, ""]);
        }, Md = (e, t) => {
          Oe(e.inputs), De(e, "ReduceSumSquare", t, (r, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${r.getByIndices("input_indices")}; value += t * t;`, ""]);
        }, Be = (e, t, n) => {
          if (t.length === 0)
            return n;
          let r = 1, o = 1;
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? "<=" : "<"} value) {
         ...
         best_index = i32(last_index);
          ...
          e.compute(Xt("ArgMin", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], n, [t.axis], 7, t.keepDims), { inputs: [0] });
        }, Qo = (e, t) => {
          jo(e.inputs);
          let n = (r, o, i) => {
            let s = [];
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? ">=" : ">"} value) {
         ...
         best_index = i32(last_index);
          ...
          e.compute(Xt("argMax", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], n, [t.axis], 7, t.keepDims), { inputs: [0] });
        }, qn = (e) => N(e);
      });
      var Rd, Fn, Ud, Vd, Nd, nt, Ld, Yo, Yt = E(() => {
        "use strict";
        V();
        q();
        Kt();
    ...
    `, Ud = (e, t, n, r, o, i, s, a) => {
          ...
          l < d && (d = 32);
          let c = Math.ceil(i / u / d), p = [{ type: 12, data: t }, { type: 12, data: n }, { type: 12, data: r }, { type: 12, data: o }, { type: 12, data: l }, { type: 12, data: c }], f = re(e.dataType, u), m = le(1, u), h = ["type"];
          ...
          let b = (y) => {
            ...
            v && _.push(v);
            let $ = le(e.dataType), T = [{ name: "batch_size", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "total_sequence_length", type: "u32" }, { name: "elements_per_thread", type: "u32" }];
            return `
    ...
    if (sum == 0) {
      ...
      ${s ? `
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          ...
          let I = (A) => {
            let z = S("q", t.dataType, t.dims, b), M = S("key", n.dataType, n.dims, b), R = [z, M];
            if (v) {
            ...
            O && R.push(O);
            let ee = C("output", t.dataType, l), G = [ee];
            c && G.push(C("present_key", t.dataType, f, b));
            let D = le(1, b), Z = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${g}u;
      ...
      var sum: f32 = ${(() => {
        ...
        output[outputIdx] = ${ee.type.value} (sum * uniforms.alpha) + ${o ? "attention_bias[outputIdx]" : "0.0"};
          ...
          let v = ($) => {
            ...
            let O = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "v_hidden_size", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${h}u;
  ...
  ${$.mainStart([h, h, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
          ...
          e.compute(Ud(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c), { inputs: l && c ? [y, l, c] : [y], outputs: [] });
          let g = [y, r];
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset("global_idx", "value")}
      ...
      var Kd, J, ri, oi, ii, si, ai, ui, di, li, ci, jd, pi, mi, fi, hi, ft, gi, Jt, yi, bi, _i, wi, $i, vi, xi, Si, Ti, Ii, Ci, Ai, ki, Ei, Pi, zi, Oi, Di, Kn, jn, Bi, Mi, Ri, Zd, Qd, Ui, en = E(() => {
        "use strict";
        V();
        q();
        ie();
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
          ...
          let n = t || jd(e.inputs), r = le(e.inputs[0].dataType);
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
          ...
          let t = le(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "Gelu", (n) => `0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`, Jt(t)));
        }, $i = (e, t) => {
          let n = le(e.inputs[0].dataType);
        ...
        }, Oi = (e) => `sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`, Di = (e) => {
...
`, jn = (e) => `(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`, Bi = (e) => {
          let t = le(e.inputs[0].dataType);
...
`, Qd = (e) => `quick_gelu_impl(${e})`, Ui = (e, t) => {
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
      ...
      var Jd, el, Me, Gi, Wi, Hi, qi, Fi, Ki, ji, Zi, Qi, Xi, Yi = E(() => {
        "use strict";
        V();
        q();
        K();
      ...
      var Ie, Ce, Ae, tn, He = E(() => {
        ...
        `;
          ...
          if (t === "HardSigmoid") {
            ...
            let [n, r] = (e == null ? void 0 : e.activation_params) || [ao, uo];
...
`;
          ...
          let w = (v) => {
            let $ = Zt("batch_dims", e[0].dataType, b.length), T = S("a", e[0].dataType, s.length, p), I = S("b", e[1].dataType, a.length, c), A = C("output", e[0].dataType, g.length, c), z = re(A.type.tensor), M = Ie(t, A.type.value, z), R = [T, I], W = "";
            if (h) {
              let G = o ? c : 1;
              R.push(S("bias", e[2].dataType, e[2].dims.length, G)), W = `${o ? `value += bias[col / ${G}];` : `value += ${A.type.value}(bias[row + i]);`}`;
            }
            let O = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }];
            Ae(t, O);
            let ee = () => {
...
`;
  ...
  `;
      ...
      var sl, al, Zn, is, ul, Qn, dl, gt, sn = E(() => {
        "use strict";
        V();
        q();
        K();
        ...
        }`, Zn = (e, t, n = "f32", r, o = false, i = 32, s = false, a = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, ul = (e) => e ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", Qn = (e, t, n = "f32", r, o = false, i = 32, s = false, a = 32, u = false) => {
...
`;
    ...
    `;
          ...
          let R = (W) => {
            let O = l.length, ee = Zt("batchDims", e[0].dataType, O, 1), G = re(e[0].dataType), D = S("a", e[0].dataType, v, _), Z = S("b", e[1].dataType, T, _), U = C("result", e[0].dataType, I.length, _), Q = [D, Z];
            if (M) {
              let L = o ? _ : 1;
              Q.push(S("bias", e[2].dataType, e[2].dims.length, L));
            }
            let _e = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }];
            Ae(t, _e);
            let se = re(U.type.tensor), H = Ie(t, U.type.value, se), k = dl(_, M, H, [ee, D, Z, U], o);
            return `
  ...
  ${h ? Zn(b, y, G, ee) : Qn(b, y, G, ee)}
          ...
          return { name: "MatMul", shaderCache: { hint: `${b};${t.activation};${h};${o}`, inputDependencies: z }, getRunData: () => ({ outputs: [{ dims: i ? i(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: g[0], y: g[1], z: g[2] }, programUniforms: A }), getShaderSource: R };
        };
      });
      var ll, ss, as = E(() => {
        "use strict";
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
          ...
          let v = h ? d && l % 4 !== 0 ? 3 : 4 : 1, $ = g[1] * _[1], T = g[0] * _[0], I = Math.max(g[0] * v, g[1]), A = r % $ === 0, z = o % T === 0, M = i % I === 0, R = h ? [v, 4, 4] : [1, 1, 1], W = [{ type: 6, data: r }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [t.pads[0], t.pads[1]] }, { type: 6, data: t.strides }, { type: 6, data: t.dilations }];
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${U}>` : U}) {
      ...
      }`, _e = S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), se = S("w", e[1].dataType, e[1].dims.length, Z), H = [_e, se], k = C("result", e[0].dataType, n.length, Z);
            if (s) {
        ...
        ${h ? Zn(_, g, U, void 0, !d, I) : Qn(_, g, U, void 0, !d, I, false, void 0, a)}`;
          };
          return { name: "Conv2DMatMul", shaderCache: { hint: `${t.cacheKey};${v};${h};${A};${z};${M};${$};${T};${I}`, inputDependencies: O }, getRunData: () => ({ outputs: [{ dims: u ? u(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: w[0], y: w[1], z: w[2] }, programUniforms: W }), getShaderSource: ee };
        };
      });
      var cl, us, an, pl, ds, ml, ls, cs, ps = E(() => {
        "use strict";
        V();
        Ee();
        q();
        ...
        cl = (e) => {
          ...
          for (let n = 0; n < e.length; n++)
            t *= e[n];
          return t;
        }, us = (e) => typeof e == "number" ? [e, e, e] : e, an = (e, t) => t <= 1 ? e : e + (e - 1) * (t - 1), pl = (e, t, n, r = 1) => {
          let o = an(t, r);
        ...
        }, ls = (e, t, n, r, o, i = false, s = "channelsLast") => {
          let a, u, d, l, c;
          if (s === "channelsLast")
            [a, u, d, l, c] = e;
  ...
  ${m.mainStart()}
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      var fl, Xn, hl, Yn, Jn, gs, gl, yl, er, ys = E(() => {
        "use strict";
        q();
        as();
        ps();
        ...
        fl = (e, t, n, r, o, i) => {
          ...
          let r = e.pads.slice();
          Ze.adjustPadsBasedOnAutoPad(t[0].dims, e.strides, e.dilations, n, r, e.format === "NHWC", e.autoPad);
          let o = Object.assign({}, e);
          return Object.assign(o, { kernelShape: n, pads: r }), o;
        }, Jn = (e) => {
          let t = tn(e), n = e.format, r = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], o = e.dilations, i = e.group, s = e.kernel_shape, a = e.pads, u = e.strides, d = e.w_is_const();
          ...
          if (n.group !== 1) {
            let $ = [t[0]];
            if (o) {
              let I = e.kernelCustomData.wT ?? e.compute(ce(t[1], Xn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
              n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = I), $.push(I);
            } else
              $.push(t[1]);
            t.length === 3 && $.push(t[2]), !e.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === n.group && t[1].dims[1] === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 ? e.compute(fs($, n, i, r), { inputs: $ }) : e.compute(ms($, n, i, r), { inputs: $ });
            return;
          }
          ...
          if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
            let $ = i[0], T, I, A, z = [];
            if (o) {
              let W = e.kernelCustomData.wT ?? e.compute(ce(t[1], Xn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
            ...
            s && z.push(t[2]);
            let M = A[2], R = z[0].dims[z[0].dims.length - 1];
            M < 8 && R < 8 ? e.compute(rn(z, n, i, A, o, r), { inputs: z }) : e.compute(gt(z, n, i, A, o, r), { inputs: z });
            return;
          }
          let b = true, y = e.kernelCustomData.wT ?? e.compute(ce(t[1], Xn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          ...
          let o = [0, t.pads[0], 0, t.pads[1]], i = [1].concat(t.strides), s = [1].concat(t.dilations), a = [1].concat(t.kernelShape), u = Yn({ ...t, pads: o, strides: i, dilations: s, kernelShape: a }, r);
          gs(e, r, u, (d) => n ? [d[0], d[2], d[3]] : [d[0], d[1], d[3]]);
        }, yl = (e, t, n) => {
          let r = n.format === "NHWC" ? "channelsLast" : "channelsFirst", o = Yn(n, t), i = n.autoPad === "NOTSET" ? n.pads : n.autoPad, s = ls(t[0].dims, t[1].dims, n.strides, n.dilations, i, false, r);
          e.compute(cs(t, o, s.outShape, [s.filterDepth, s.filterHeight, s.filterWidth], [s.padInfo.front, s.padInfo.top, s.padInfo.left], r));
        }, er = (e, t) => {
    ...
    ${se}}`;
      ...
      var bl, _l, wl, ws, $s, $l, vs, vl, xs, Ss = E(() => {
        "use strict";
        _s();
        He();
        Re();
        bl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i, _l = (e, t, n, r, o) => {
          ...
          let t = tn(e), n = e.format, r = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][typeof e.autoPad > "u" ? 0 : e.autoPad], o = e.dilations, i = e.group, s = e.kernelShape, a = e.pads, u = e.strides, d = e.wIsConst(), l = e.outputPadding, c = e.outputShape;
          ...
          let o = e.kernelCustomData.wT ?? e.compute(ce(t[1], [2, 3, 0, 1]), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          ...
          u = [0].concat(u);
          let d = ws({ ...t, pads: a, strides: s, dilations: i, kernelShape: o, outputPadding: u }, r);
...
`);
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
      ...
      var tr, un, Ps, Cl, Al, nr, rr, zs, kl, Os, Ds, Bs = E(() => {
        "use strict";
        V();
        q();
        ie();
        K();
        tr = "[a-zA-Z]|\\.\\.\\.", un = "(" + tr + ")+", Ps = "^" + un + "$", Cl = "(" + un + ",)*" + un, Al = "^" + Cl + "$", nr = class {
          constructor(t = -1) {
          ...
          processTerm(t, n, r, o = -1) {
            ...
            if (!t.match(RegExp(Ps)) && !n && t !== "")
              throw new Error("Invalid LHS term");
            let d = t.match(RegExp(tr, "g")), l = new nr(o);
          ...
          let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)), s = x.size(r), a = C("output", t, r.length), u = [...n.symbolToInfo.keys()].filter((l) => !n.rhs.symbolToIndices.has(l)), d = (l) => {
            ...
            n.symbolToInfo.forEach((v, $) => {
              ...
              if (n.rhs.symbolToIndices.has($)) {
                ...
                }), b.push(`for(var ${$}: u32 = 0; ${$} < uniforms.${zs($)}; ${$}++) {`), y.push("}");
            });
...
`)};
          ...
          let n = new rr(e.inputs, t.equation), r = n.outputDims, o = e.inputs.map((i, s) => i.dims);
      ...
      var El, Ms, Pl, zl, Rs, Us = E(() => {
        ...
        El = (e) => {
          ...
          return r;
        }, Pl = (e, t) => e.length > t.length ? Ms(e, t) : Ms(t, e), zl = (e) => {
    ...
    ${s.mainStart(Qe)}
      ...
      ${d.setByOffset("global_idx", jn("x_in"))}
          ...
          return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: i, getRunData: (s) => ({ outputs: [{ dims: s[0].dims, dataType: s[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(n / 4) }, { type: 12, data: r }], dispatchGroup: { x: Math.ceil(n / Qe / 4) } }) };
        }, Vs = (e) => {
          e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Bi(e) : e.compute(Ol(e.inputs));
        };
      });
      var Dl, Bl, Ls, Gs, Ws = E(() => {
        "use strict";
        V();
        q();
        ie();
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      var Rl, Ul, Ks, js, Zs = E(() => {
        ...
        }, js = (e) => N({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis });
      });
      var Vl, Nl, Qs, Xs, Ys = E(() => {
        "use strict";
        V();
        q();
        ie();
      ...
      ${f.setByOffset("global_idx", "value")};
        ...
        }, Qs = (e) => N({ axis: e.axis }), Xs = (e, t) => {
          let n = e.inputs;
          Vl(n), e.compute(Nl(e.inputs, t));
        };
      });
      var Ll, Gl, Js, ea, ta = E(() => {
        "use strict";
        V();
        q();
        K();
        Ll = (e) => {
          ...
          let n = e[0].dims.slice(), r = e[1].dims.slice(), [o, i, s] = Lt.getShapeOfGemmResult(n, t.transA, r, t.transB, e.length === 3 ? e[2].dims : void 0), a = [o, i];
          if (!a)
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      var Ue, qe, rt, ot, Wl, Hl, ql, Fl, Kl, jl, Zl, Ql, na, ra, oa = E(() => {
        "use strict";
        V();
        q();
        ie();
        K();
        [Ue, qe, rt, ot] = [0, 1, 2, 3], Wl = (e) => {
          if (e[0].dims.length !== 4)
...
`, Zl = (e, t, n) => (() => {
        ...
        `;
          ...
          t.format === "NHWC" && (i = [e[0].dims[0], e[1].dims[1], e[1].dims[2], e[0].dims[3]], [Ue, qe, rt, ot] = [0, 3, 1, 2]);
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Zl(s, a, t)}
        ...
        }, ra = (e) => N({ alignCorners: e.align_corners, mode: e.mode, paddingMode: e.padding_mode, format: e.format });
      });
      var he, Jl, sa, ia, ec, yt, aa, or = E(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        K();
        Re();
        he = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, Jl = (e, t) => {
          let n = e[0], r = he(e, 1), o = he(e, 2), i = he(e, 3), s = he(e, 4), a = he(e, 5), u = he(e, 6), d = he(e, 7);
        ...
        }, sa = (e) => N({ ...e }), ia = N({ perm: [0, 2, 1, 3] }), ec = (e, t, n, r, o, i, s) => {
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
          ...
          if (s && x.size(s.dims) > 0) {
            ...
            return u = ec(e, i, s, t, r, n * o, a), u = u.reshape([t, r, n, o]), n === 1 || r === 1 ? u : e.compute(ce(u, ia.perm), { inputs: [u], outputs: [-1] })[0];
          } else
            return i.dims.length === 3 && (u = i.reshape([t, r, n, o])), n === 1 || r === 1 ? u : e.compute(ce(u, ia.perm), { inputs: [u], outputs: [-1] })[0];
        }, aa = (e, t) => {
          let n = Jl(e.inputs, t), r = e.inputs[0], o = he(e.inputs, 1), i = he(e.inputs, 2), s = he(e.inputs, 3), a = he(e.inputs, 4), u = he(e.inputs, 5), d = he(e.inputs, 6), l = he(e.inputs, 7);
          if (r.dims.length === 5)
            throw new Error("Packed QKV is not implemented");
          if ((o == null ? void 0 : o.dims.length) === 5)
            throw new Error("Packed KV is not implemented");
          let c = o && i && o.dims.length === 4 && i.dims.length === 4, p = yt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, r, s, 0);
          if (c)
            return nt(e, p, o, i, a, void 0, d, l, u, n);
          if (!o || !i)
            throw new Error("key and value must be provided");
          let f = yt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.headSize, o, s, n.hiddenSize), m = yt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.vHeadSize, i, s, 2 * n.hiddenSize);
          nt(e, p, f, m, a, void 0, d, l, u, n);
        };
      });
      var tc, nc, rc, oc, ir, ua, da, sr = E(() => {
        "use strict";
        V();
        q();
        ie();
...
`)}
    ...
    writeBufferData(output_number, indices, global_idx);
      ...
      var ic, dn, la, ar = E(() => {
        ...
        ${b.mainStart(Qe)}
          ...
          return { name: "RotaryEmbedding", shaderCache: { hint: N({ interleaved: n }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: h, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(x.size(p) / Qe) }, programUniforms: m }) };
        }, la = (e, t) => {
          ic(e.inputs, t), e.compute(dn(e.inputs, t));
        };
      });
      var sc, ac, ca, uc, pa, ma = E(() => {
        "use strict";
        ie();
        V();
        Yt();
        ...
        }, ac = N({ perm: [0, 2, 1, 3] }), ca = (e, t, n) => {
          let r = t, o = n.kvNumHeads;
          return t.dims.length === 3 && n.kvSequenceLength !== 0 && (r = t.reshape([n.batchSize, n.kvSequenceLength, o, n.headSize]), r = e.compute(ce(r, ac.perm), { inputs: [r], outputs: [-1] })[0]), r;
        }, uc = (e, t, n, r) => {
  ...
  `;
          ...
          let y = yt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, t.doRotary ? h : p, void 0, 0), g = ca(e, t.doRotary ? b : f, n), _ = ca(e, m, n);
          nt(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
        };
      });
      var fa, dc, lc, ha, ga = E(() => {
        "use strict";
        V();
        q();
        Re();
  ...
  ${g.mainStart(p)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
          ...
          let r = t[0].dims, o = r, i = 2, s = r[0], a = r[1], u = x.sizeFromDimension(r, i), d = X(u), l = x.size(o) / d, c = fa(e, t[0], t[1], t[2], s, u, a, n.epsilon), p = [s, a, u / d], f = [s, a], m = ["type", "none"], h = (b) => {
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${_.setByOffset("global_idx", "value")};
          ...
          p = p && r[r.length - 1] !== 1;
          let m = p ? e.compute(ce(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0] : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])), h = fa(e, m, t[1], t[2], i, a, s, n.epsilon), b = (y) => {
  ...
  ${v.mainStart()}
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
      ...
      var mc, _a, wa = E(() => {
        ...
        mc = (e) => {
          ...
          if (n < 8 && r < 8)
            e.compute(rn(e.inputs, { activation: "" }, t));
          else {
            ...
            if (i !== 1 && o === 1 && s === 1) {
              ...
              e.compute(gt(e.inputs, { activation: "" }, t));
          }
        };
      });
      var fc, hc, gc, $a, va, xa = E(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        fc = (e, t) => {
          ...
          _.push(...P($));
          let T = (I) => {
            let A = w.length, z = S("a", e[0].dataType, A, p), M = S("b", 12, v.length, f), R = S("scales", e[2].dataType, e[2].dims.length), W = [z, M, R], O = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            O && W.push(O);
            let ee = $.length, G = C("output", e[0].dataType, ee, m), D = re(e[0].dataType), Z = (() => {
              switch (p) {
                case 1:
                  return `array<${D}, 8>`;
                case 2:
        ...
        ${I.mainStart([g, 1, 1])}
          ...
          $.push(...P(A));
          let z = (M) => {
            let R = T.length, W = S("a", e[0].dataType, R, p), O = S("b", 12, I.length, f), ee = S("scales", e[2].dataType, e[2].dims.length), G = [W, O, ee], D = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            D && G.push(D);
            let Z = A.length, U = C("output", e[0].dataType, Z), Q = re(e[0].dataType), _e = () => {
              switch (p) {
                case 1:
                  return `
      ...
      var yc, bc, _c, wc, $c, vc, xc, Sc, Sa, Ta = E(() => {
        "use strict";
        V();
        q();
        K();
      ...
      var ln, Ia, Ca, Aa, ka, Tc, Ic, Ea, Pa, za, Oa, Da, Ba, Ma, Ra, Ua, Va, Na, La, Ga = E(() => {
        "use strict";
        ve();
        V();
        q();
        ...
        ln = (e) => {
          ...
          let l = Ze.computePoolOutputShape(n, o, a, u, s, d, t.autoPad), c = Object.assign({}, t);
        ...
        }, ka = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, Tc = (e) => `${ka(e)};${e.countIncludePad}`, Ic = (e) => `${ka(e)};${e.storageOrder};${e.dilations}`, Ea = (e) => ({ format: e.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], ceilMode: e.ceil_mode, kernelShape: e.kernel_shape, strides: e.strides, pads: e.pads }), Pa = (e, t, n, r) => {
          let [o, i] = Ia(t, r, n), s = S("x", t.dataType, t.dims.length), a = s.type.value, u = "value += x_val;", d = "";
          o.countIncludePad ? d += `value /= ${a}(uniforms.kernelSize);` : d += `value /= ${a}(i32(uniforms.kernelSize) - pad);`;
          let [l, c, p, f, m] = Ca(i, o);
          l.push(...P(t.dims, i));
          let h = ["rank"];
          return { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: h }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (b) => Aa(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m) };
        }, za = (e) => {
          let t = e.count_include_pad !== 0, n = Ea(e);
          if (n.ceilMode !== 0)
            throw new Error("using ceil() in shape computation is not yet supported for AveragePool");
          let r = { countIncludePad: t, ...n, cacheKey: "" };
          return { ...r, cacheKey: Tc(r) };
        }, Oa = (e, t) => {
          ln(e.inputs), e.compute(Pa("AveragePool", e.inputs[0], false, t));
        }, Da = { autoPad: "", ceilMode: 0, countIncludePad: false, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, Ba = (e) => {
          let t = e.format;
          return { format: t, ...Da, cacheKey: t };
        }, Ma = (e, t) => {
          ln(e.inputs), e.compute(Pa("GlobalAveragePool", e.inputs[0], true, t));
        }, Ra = (e, t, n, r) => {
          let [o, i] = Ia(t, r, n), s = `
      value = max(x_val, value);
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = Ca(i, o);
          return l.push(...P(t.dims, i)), { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: d }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (h) => Aa(h, u, t.dims.length, i.length, o, s, a, t.dataType === 10 ? -65504 : -1e5, c, p, f, m) };
        }, Ua = (e, t) => {
          ln(e.inputs), e.compute(Ra("MaxPool", e.inputs[0], false, t));
        }, Va = (e) => {
          let t = e.storage_order, n = e.dilations, r = Ea(e);
          if (t !== 0)
          ...
          ln(e.inputs), e.compute(Ra("GlobalMaxPool", e.inputs[0], true, t));
        };
      });
      var Ac, kc, Wa, Ha, qa = E(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        Ac = (e, t) => {
          ...
          let A = [{ type: 12, data: a / y }, { type: 12, data: n }, { type: 12, data: t.blockSize }, ...P(...I, i)], z = (M) => {
            let R = [{ name: "output_size", type: "u32" }, { name: "axis", type: "u32" }, { name: "block_size", type: "u32" }];
            return `
      ...
      var Ec, Pc, Fa, Ka = E(() => {
        ...
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
          ...
          let t = 0, n = 0, r = 0;
          e.inputs[0].dataType === 6 ? (t = e.inputs[0].getInt32Array()[0], n = e.inputs[1].getInt32Array()[0], r = e.inputs[2].getInt32Array()[0]) : e.inputs[0].dataType === 1 && (t = e.inputs[0].getFloat32Array()[0], n = e.inputs[1].getFloat32Array()[0], r = e.inputs[2].getFloat32Array()[0]), te.webgpu.validateInputContent && Ec(t, n, r), e.compute(Pc(t, n, r, e.inputs[0].dataType), { inputs: [] });
        };
      });
      var zc, ja, Za, Oc, Qa, Xa, Ya = E(() => {
        "use strict";
        V();
        q();
        ie();
    ...
    data_offset += u32((u32(index) * element_count_dim));`, Za = (e, t, n) => `for (var i = 0u; i < uniforms.num_updates_elements; i++) {
        ...
        ${zc(e.reduction, "output[data_offset + i]", "value", t)}
          ...
          let n = e[0].dims, r = e[1].dims, o = n, i = 1, s = Math.ceil(x.size(r) / i), a = r[r.length - 1], u = x.sizeFromDimension(n, a), d = x.sizeFromDimension(r, 0) / a, l = [{ type: 12, data: s }, { type: 12, data: a }, { type: 12, data: u }, ...P(e[1].dims, e[2].dims, o)], c = (p) => {
            let f = S("indices", e[1].dataType, e[1].dims.length), m = S("updates", e[2].dataType, e[2].dims.length, i), h = t.reduction !== "none" && t.reduction !== "" ? vo("output", e[0].dataType, o.length) : C("output", e[0].dataType, o.length, i);
            return `
  ...
  ${Za(t, h.type.value, true)}
  }`;
          };
          return { name: "ScatterND", shaderCache: { hint: `${t.cacheKey}_${t.reduction}`, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: o, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(s / 64) }, programUniforms: l }), getShaderSource: c };
        }, Qa = (e) => N({ reduction: e.reduction }), Xa = (e, t) => {
          e.compute(Oc(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
        };
      });
      var Dc, Bc, Mc, Ja, Rc, Uc, Vc, Nc, Lc, Gc, Wc, Hc, eu, qc, Fc, Kc, jc, Zc, tu, nu, ru = E(() => {
        "use strict";
        V();
        q();
        ie();
...
`, Rc = (e, t) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` + (() => {
        ...
        })() + "}", Uc = (e, t, n) => `fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {` + (() => {
          switch (e) {
...
`}
      ...
      var Yc, cn, Jc, su, ep, tp, au, uu, du = E(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        Yc = (e, t) => {
          ...
          if (e.length > 1) {
            let n = cn(e, 1), r = cn(e, 2), o = cn(e, 3);
          ...
          let n = e[0].dims, r = x.size(n), o = t.axes.length > 0 ? x.normalizeAxes(t.axes, n.length) : [...Array(n.length).keys()], i = cn(e, 4);
          i.forEach((y) => y !== 0 || (() => {
      ...
      var np, rp, lu, cu, pu = E(() => {
        ...
        np = (e) => {
          ...
          a ? (d = Array.from({ length: i }, (T, I) => I), d[s] = i - 1, d[i - 1] = s, u = e.compute(ce(n, d), { inputs: [n], outputs: [-1] })[0]) : u = n;
      ...
      var pn, wu = E(() => {
        ...
        pn = class {
          ...
          build(t, n) {
            ...
            let s = xo(n, this.backend.device.limits), a = t.getShaderSource(s), u = `${o.join(`
`)}
...
${a}`, d = r.createShaderModule({ code: u, label: t.name });
            ...
            return me(t.name), { programInfo: t, computePipeline: l, uniformVariablesInfo: s.variablesInfo };
          }
      ...
      var dp, lp, ur, dr, vu = E(() => {
        ...
        dp = (e, t) => {
          ...
          async initialize(t, n) {
            ...
            i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await n.requestDevice(o), this.adapterInfo = new ur(n.info || await n.requestAdapterInfo()), this.gpuDataManager = wo(this), this.programManager = new pn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Nt(t.logLevel, !!t.debug), this.device.onuncapturederror = (s) => {
            ...
            this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
              ...
              for (let o = 0; o < n.length / 2; o++) {
                ...
                if ((_a2 = this.env.webgpu.profiling) == null ? void 0 : _a2.ondata)
                  this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: c.map((y) => ({ dims: y.dims, dataType: ke(y.dataType) })), outputsMetadata: p.map((y) => ({ dims: y.dims, dataType: ke(y.dataType) })), kernelId: s, kernelType: u, kernelName: d, programName: l, startTime: h, endTime: b });
                else {
                  let y = "";
                  c.forEach((_, w) => {
          ...
          run(t, n, r, o, i, s) {
            ...
            if (l) {
              ...
              l.forEach((I) => {
                ...
                if (A.length === 0)
                  return;
                let z = I.type === 10 ? 2 : 4, M, R;
                I.type === 10 ? (R = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * z, M = A.length > 4 ? 16 : z * A.length) : (R = A.length <= 2 ? A.length * z : 16, M = 16), _ = Math.ceil(_ / R) * R, w.push(_);
                let W = I.type === 10 ? 8 : 4;
      ...
      var bt, lr, cp, Su = E(() => {
        ...
        bt = class e {
          ...
          compute(t, n) {
            var _a2;
            let r = ((_a2 = n == null ? void 0 : n.inputs) == null ? void 0 : _a2.map((a) => typeof a == "number" ? this.inputs[a] : a)) ?? this.inputs, o = (n == null ? void 0 : n.outputs) ?? [], i = (a, u, d) => new bt(this.module, u, this.output(a, d), d), s = (a, u) => {
              let d = We(a, u);
              if (!d)
          ...
          if (e === "webgpu") {
            let i = (vu(), at($u)).WebGpuBackend, s = new i();
      ...
      var pp, Ct, At, Ye, mp, Tu, lt, kt, Et, Iu, Pt, zt, Ot, In = E(() => {
        "use strict";
        no();
        oo();
        V();
        ...
        pp = (e, t) => {
          ...
          var _a2, _b, _c2, _d2;
          let n, r, o = ne();
          Array.isArray(e) ? [n, r] = e : e.buffer === o.HEAPU8.buffer ? [n, r] = [e.byteOffset, e.byteLength] : [n, r] = lt(e);
          let i = 0, s = 0, a = 0, u = [], d = [], l = [];
          try {
            if ([s, u] = await ro(t), (t == null ? void 0 : t.externalData) && o.mountExternalData) {
              let w = [];
              for (let v of t.externalData) {
                let $ = typeof v == "string" ? v : v.path;
                w.push(mt(typeof v == "string" ? v : v.data).then((T) => {
            ...
            for (let w = 0; w < c; w++) {
              ...
              m.push(I), b.push($ === 0 ? { name: I, isTensor: false } : { name: I, isTensor: true, type: ke($), shape: T });
            }
            for (let w = 0; w < p; w++) {
              let [v, $, T] = Tu(i, w + c);
            ...
            let _ = null;
            return g.some((w) => w === "gpu-buffer" || w === "ml-tensor" || w === "ml-tensor-cpu-output") && (a = o._OrtCreateBinding(i), a === 0 && Y("Can't create IO binding."), _ = { handle: a, outputPreferredLocations: g, outputPreferredLocationsEncoded: g.map((w) => w === "ml-tensor-cpu-output" ? "ml-tensor" : w).map((w) => En(w)) }), Ye.set(i, [i, d, l, _, f, false]), [i, m, h, b, y];
          } catch (c) {
          ...
          var _a2, _b, _c2, _d2;
          let s = ne(), a = s.PTR_SIZE, u = Ye.get(e);
          if (!u)
          ...
          try {
            ...
            if (p && !m) {
              let { handle: O, outputPreferredLocations: ee, outputPreferredLocationsEncoded: G } = p;
              if (l.length !== h)
                throw new Error(`input count from feeds (${h}) is expected to be always equal to model's input count (${l.length}).`);
              for (let D = 0; D < h; D++) {
                let Z = t[D];
                await s._OrtBindInput(O, l[Z], _[D]) !== 0 && Y(`Can't bind input[${D}] for session=${e}.`);
              }
              for (let D = 0; D < b; D++) {
                let Z = r[D];
                ((_a2 = o[D]) == null ? void 0 : _a2[3]) ? s._OrtBindOutput(O, c[Z], w[D], 0) !== 0 && Y(`Can't bind pre-allocated output[${D}] for session=${e}.`) : s._OrtBindOutput(O, c[Z], 0, G[Z]) !== 0 && Y(`Can't bind output[${D}] to ${ee[D]} for session=${e}.`);
              }
              Ye.set(e, [d, l, c, p, f, true]);
            }
            ...
            for (let O = 0; O < b; O++) {
              ...
              let G = s.stackSave(), D = s.stackAlloc(4 * a), Z = false, U, Q = 0;
              try {
                s._OrtGetTensorData(ee, D, D + a, D + 2 * a, D + 3 * a) !== 0 && Y(`Can't access output tensor data on index ${O}.`);
                let se = a === 4 ? "i32" : "i64", H = Number(s.getValue(D, se));
                Q = s.getValue(D + a, "*");
                let k = s.getValue(D + a * 2, "*"), L = Number(s.getValue(D + a * 3, se)), oe = [];
                ...
                U = ke(H);
                let Se = p == null ? void 0 : p.outputPreferredLocations[r[O]];
                if (U === "string") {
                  if (Se === "gpu-buffer" || Se === "ml-tensor")
                    throw new Error("String tensor is not supported on GPU.");
                  let ue = [];
                  for (let ae = 0; ae < we; ae++) {
                    let Ve = s.getValue(Q + ae * a, "*"), wt = s.getValue(Q + (ae + 1) * a, "*"), fr = ae === we - 1 ? void 0 : wt - Ve;
                  ...
                  let ae = ue(Q), Ve = We(H, we);
                  if (Ve === void 0 || !Ut(U))
                    throw new Error(`Unsupported data type: ${U}`);
                  Z = true, R.push([U, oe, { gpuBuffer: ae, download: s.jsepCreateDownloader(ae, Ve, U), dispose: () => {
                  ...
                  if (We(H, we) === void 0 || !Vt(U))
                    throw new Error(`Unsupported data type: ${U}`);
                  if (!ae(e, U, false))
                    throw new Error(`preferredLocation "ml-tensor" for ${U} output is not supported by current WebNN Context.`);
                  let wt = await ue(e, Q, H, oe, false);
                  Z = true, R.push([U, oe, { mlTensor: wt, download: s.webnnCreateMLTensorDownloader(Q, U), dispose: () => {
                    s.webnnReleaseTensorId(Q), s._OrtReleaseTensor(ee);
                  } }, "ml-tensor"]);
                } else if (Se === "ml-tensor-cpu-output" && we > 0) {
                  let ue = s.webnnCreateMLTensorDownloader(Q, U)(), ae = R.length;
                  Z = true, W.push((async () => {
                    let Ve = [ae, await ue];
                    return s.webnnReleaseTensorId(Q), s._OrtReleaseTensor(ee), Ve;
                  })()), R.push([U, oe, [], "cpu"]);
                } else {
                  let ue = tt(U), ae = new ue(we);
                  new Uint8Array(ae.buffer, ae.byteOffset, ae.byteLength).set(s.HEAPU8.subarray(Q, Q + ae.byteLength)), R.push([U, oe, ae, "cpu"]);
                }
              } finally {
                s.stackRestore(G), U === "string" && Q && s._free(Q), Z || s._OrtReleaseTensor(ee);
              }
            }
            p && !f && (s._OrtClearBoundOutputs(p.handle) !== 0 && Y("Can't clear bound outputs."), Ye.set(e, [d, l, c, p, f, false]));
            for (let [O, ee] of await Promise.all(W))
              R[O][2] = ee;
            return R;
          } finally {
      ...
      var Je, xe, _t, fn, hn, mn, cr, pr, it, st, hp, Cu, Au, ku, Eu, Pu, zu, Ou, mr = E(() => {
        "use strict";
        ve();
        In();
        Le();
        Tt();
        Je = () => !!te.wasm.proxy && typeof document < "u", _t = false, fn = false, hn = false, pr = /* @__PURE__ */ new Map(), it = (e, t) => {
          let n = pr.get(e);
          ...
          switch (e.data.type) {
            case "init-wasm":
              _t = false, e.data.err ? (hn = true, cr[1](e.data.err)) : (fn = true, cr[0]()), mn && (URL.revokeObjectURL(mn), mn = void 0);
              break;
            case "init-ep":
            case "copy-from":
            case "create":
          ...
          if (!fn) {
            ...
            if (_t = true, Je())
              return new Promise((e, t) => {
                xe == null ? void 0 : xe.terminate(), Yr().then(([n, r]) => {
                  try {
            ...
            try {
              await It(te.wasm), await Ct(te), fn = true;
            } catch (e) {
              throw hn = true, e;
            } finally {
              _t = false;
          ...
          await At(te, e);
        }, ku = async (e) => Je() ? (st(), new Promise((t, n) => {
          it("copy-from", [t, n]);
      ...
      var Du, gp, gn, Bu = E(() => {
        ...
        Du = (e, t) => {
          ...
          async loadModel(t, n) {
            fe();
            let r;
            typeof t == "string" ? r = await this.fetchModelAndCopyToWasmMemory(t) : r = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await Eu(r, n), me();
          }
          async dispose() {
      ...
      var Ru = {};
      et(Ru, { OnnxruntimeWebAssemblyBackend: () => yn, initializeFlags: () => Mu, wasmBackend: () => yp });
      var Mu, yn, yp, Uu = E(() => {
        "use strict";
        ve();
        mr();
        ...
        Mu = () => {
          ...
          if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), te.wasm.simd = false), typeof te.wasm.proxy != "boolean" && (te.wasm.proxy = false), typeof te.wasm.trace != "boolean" && (te.wasm.trace = false), typeof te.wasm.numThreads != "number" || !Number.isInteger(te.wasm.numThreads) || te.wasm.numThreads <= 0)
            if (typeof self < "u" && !self.crossOriginIsolated)
              ...
              let t = typeof navigator > "u" ? _n("node:os").cpus().length : navigator.hardwareConcurrency;
      ...
      var _p = {};
      et(_p, { InferenceSession: () => Ur, TRACE: () => dt, TRACE_FUNC_BEGIN: () => fe, TRACE_FUNC_END: () => me, Tensor: () => $e, default: () => bp, env: () => te, registerBackend: () => Ne });
      ve();
      ve();
      ve();
      var Hr = "1.22.0";
      ...
      Object.defineProperty(te.versions, "web", { value: Hr, enumerable: true });
      return at(_p);
    })();
